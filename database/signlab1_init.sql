...
-- 学生班级关联数据
INSERT INTO student_class_relations (student_code, class_code) VALUES 
('S001', '202101'),
('S002', '202101'),
('S003', '202102');
...
CREATE INDEX idx_courses_teacher_code ON courses(teacher_code);
...
CREATE INDEX idx_attendance_student_code ON attendance_records(student_code);
